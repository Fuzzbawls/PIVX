...
def build():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/pivx-*-win-unsigned.tar.gz inputs/pivx-win-unsigned.tar.gz', shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/pivx-*-osx-unsigned.tar.gz inputs/pivx-osx-unsigned.tar.gz', shell=True)
