...
typedef boost::variant<libzcash::InvalidEncoding, libzcash::SproutPaymentAddress, libzcash::SaplingPaymentAddress, CBitcoinAddress> PPaymentAddress;
...
public:
    ...
    UniValue operator()(const CBitcoinAddress &address) const {
        UniValue ret(UniValue::VOBJ);
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    ...
    if (isValid) {
        ...
        UniValue detail = boost::apply_visitor(DescribePaymentAddressVisitor(), finalAddress);
        ret.pushKVs(detail);
    }
